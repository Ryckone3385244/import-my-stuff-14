...
const ExhibitorOnsite = () => {
      ...
      component: (
        <section className="py-12">
          <div className="container mx-auto px-4">
            <EditableText 
              pageName="exhibitor-onsite" 
              sectionName="title" 
              contentKey="heading" 
              defaultValue="Onsite Information" 
  ...
  return (
    <>
      <Helmet>
        <title>Onsite Information | Exhibitor Portal</title>
      </Helmet>
...
export default ExhibitorOnsite;