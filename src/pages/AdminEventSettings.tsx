...
import { AdminEventSettings as EventSettingsComponent } from "@/components/AdminEventSettings";
        ...
        <div className="flex-1 bg-muted/30 pt-[168px] pb-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold mb-2">Event Settings</h1>
                <p className="text-muted-foreground">
                  Manage your event details, dates, and general information
                </p>
              </div>
