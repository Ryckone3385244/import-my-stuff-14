...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      is_admin_or_cs: { Args: { _user_id: string }; Returns: boolean }
      is_admin_or_cs_or_pm: { Args: { _user_id: string }; Returns: boolean }
      is_exhibitor: { Args: { _user_id: string }; Returns: boolean }
      is_syncing_deadlines: { Args: never; Returns: boolean }
      is_syncing_social_media: { Args: never; Returns: boolean }
      reset_submission_approval: {
        Args: { p_exhibitor_id: string; p_submission_type: string }
        Returns: undefined
      }
      sync_draft_sessions_to_event: {
      ...
      sync_speaker_submissions_to_event: {
        Args: { target_event_id: string }
        Returns: {
          new_speaker_id: string
          old_speaker_id: string
